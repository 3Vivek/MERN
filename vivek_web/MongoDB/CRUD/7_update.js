...
const updateDoc=async(_id)=>{
    try{
        //updateOne=>only show the update had occired not show the details of update
        //findByIdAndUpdate=>show prev collection before update 
        ...
        const res=await PlayList.findByIdAndUpdate({_id},{
            ...
            {
                new:true //now it shows the updated value
            }
...
updateDoc("64cb418dfbd9044f712224e9");
